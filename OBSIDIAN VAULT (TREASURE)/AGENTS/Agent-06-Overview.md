...
## Role Description
QA Automation & Security Auditor responsible for `pytest` unit/integration test suites, `ffprobe` video render output probing, crash recovery testing, and secret leak prevention.
