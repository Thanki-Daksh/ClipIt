...
# ⚖️ AGENT 06: DECISIONS LOG

- 🧪 **[[Agent-06-QA-Security-Auditor| Back to Agent 06 Hub]]**

## ADR-006: Automated ffprobe Stream Probing in Integration Tests
- **Status**: Approved
- **Decision**: Programmatically run `ffprobe` in integration tests to verify video streams match 1080x1920 9:16 aspect ratio before marking render tests as passed.
