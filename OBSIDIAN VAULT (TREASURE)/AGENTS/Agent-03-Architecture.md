...
# 🏗️ AGENT 03: ARCHITECTURE

- 🎬 **[[Agent-03-Media-Graphics-Engineer| Back to Agent 03 Hub]]**

## 🎬 Media Graphics Architecture
- **Core Files**: `modules/clipper.py`, `captioner.py`, `metadata.py`
- **Video Crop**: FFmpeg `crop=ih*(9/16):ih`
- **Subtitles**: ASS v4.00+ with active word BGR highlight codes
